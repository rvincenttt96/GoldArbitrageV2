...
r=requests.get('https://api.wallgold.ir/api/v1/account/price',headers={'Accept':'application/json','Authorization':'Bearer 7969175|1JKem5nzDrdrYUfGMCITVFiwGa5eOqXd8zLC5PYE9425d863'},params={'symbol':'GLD_18C_750TMN','side':'buy'})
print('RAW TEST:',r.status_code,r.text)
...
print('WALL BEFORE GOLDIKA')
print(wallgold.get_price('buy'))
goldika.login()

print('WALL HEADERS:', wallgold.session.headers)

r = wallgold.session.get('https://api.wallgold.ir/api/v1/account/price', params={'symbol':'GLD_18C_750TMN','side':'buy'})
print('STATUS DIRECT:', r.status_code)
print('TEXT DIRECT:', r.text)

print('WALL DIRECT TEST')
test_wall = WallGoldClient('7969175|1JKem5nzDrdrYUfGMCITVFiwGa5eOqXd8zLC5PYE9425d863')
print(test_wall.get_price('buy'))
